...
ctx.lineWidth = 5;
ctx.arc(x=150, y=143, r=40, startAngle=0, Math.PI.endAngle=2);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(x=350, y=210, r=40, startAngle=0,   Math.PI.endAngle=2);
ctx.stroke();
...
ctx.strokeStyle = "red";
ctx.lineWidth = 5;
ctx.arc(x=210, y=40, r=40, startAngle=0, Math.PI.endAngle=2);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(x=300, y=250, r=40, startAngle=0, Math.PI.endAngle=2);
ctx.stroke();
